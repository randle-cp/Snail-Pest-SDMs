...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Parmarion_martensi_qGIS_clean_Grp1.csv')
...
samp1 <- spsample(pol, nrow(pres_train)*4, type='random', iter=25)
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Temp_Ann_Range + MeanTemp_WettestQ + Ann_Precip + Precip_DriestWk + Precip_ColdestQ + Highest_Weekly_Rad + Lowest_Weekly_Rad + Rad_WarmestQ + MeanMoisture_WarmestQ + Elev + Human_Impact,
