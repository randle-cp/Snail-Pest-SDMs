...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Parmarion_martensi_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Temp_Ann_Range + MeanTemp_WettestQ + Ann_Precip + Precip_WarmestQ +  Precip_ColdestQ + Highest_Weekly_Rad + Lowest_Weekly_Rad + Rad_WarmestQ + Moisture_Seasonality + Elev + Human_Impact,
