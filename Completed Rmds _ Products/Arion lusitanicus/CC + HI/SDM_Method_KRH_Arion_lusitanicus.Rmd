...
```{r}
sdmdata<-read.csv(file='Arion_lusitanicus_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Isothermality + Precip_DriestWk + Rad_WettestQ + Rad_WarmestQ + Moisture_Seasonality + Elev + Human_Impact                      ,
