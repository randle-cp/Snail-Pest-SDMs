...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Cernuella_neglecta_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Isothermality + Temp_Seasonality + MeanTemp_WettestQ +    
Ann_Precip + Precip_Seasonality + Highest_Weekly_Rad + Lowest_Weekly_Seasonality + Highest_Weekly_Moisture + Elev + Human_Impact                      ,
