...
pres_test2<-read.csv('C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Monacha_cartusiana_US_Occurrences.csv')
...
samp2 <- spsample(pol, 10*length(pres_test2), type='random', iter=25)
