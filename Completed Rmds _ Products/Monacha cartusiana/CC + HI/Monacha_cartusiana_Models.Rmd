...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Monacha_cartusiana_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Ann_Mean_Temp + Mean_Diurnal_Temp_Range + Temp_Seasonality + Precip_Seasonality + Precip_ColdestQ +  Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_DriestQ + Rad_WarmestQ + Moisture_Seasonality + MeanMoisture_ColdestQ + Elev + Human_Impact,
