...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Temp_Seasonality + MaxTemp_WarmestWeek + Precip_DriestWk + Precip_WettestWk + Precip_Seasonality + Precip_ColdestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_WarmestQ + Rad_ColdestQ + MeanMoisture_WarmestQ + Elev + Human_Impact,
