...
```{r}
sdmdata<-read.csv(file='Arion_vulgaris_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Temp_Seasonality + MaxTemp_WarmestWeek + Precip_Seasonality + Rad_WettestQ + Rad_DriestQ + Rad_WarmestQ + Rad_ColdestQ + Highest_Weekly_Moisture + Moisture_Seasonality + Elev + Human_Impact                      ,
