...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Theba_pisana_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Isothermality + MeanTemp_WettestQ + Precip_DriestWk + Precip_WettestWk + Precip_Seasonality + Highest_Weekly_Rad + Rad_WettestQ + Rad_DriestQ + Rad_ColdestQ + MeanMoisture_ColdestQ + Elev + Human_Impact,
