...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Monacha_cantiana_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Isothermality + Temp_Seasonality + MinTemp_ColdestWeek + MeanTemp_DriestQ +    
Precip_Seasonality + Precip_WarmestQ + Precip_ColdestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + Elev + Human_Impact                      ,
