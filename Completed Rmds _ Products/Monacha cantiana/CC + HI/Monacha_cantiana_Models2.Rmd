...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Monacha_cantiana_qGIS_clean2.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Isothermality + Temp_Seasonality + MinTemp_ColdestWeek + MeanTemp_DriestQ + Precip_Seasonality + Precip_WarmestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + MeanMoisture_ColdestQ + Elev + Human_Impact,
...
e
```
and the Boyce plot for the ensemble
```{r}
