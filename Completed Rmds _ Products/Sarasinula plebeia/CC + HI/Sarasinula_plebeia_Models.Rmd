...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Sarasinula_plebeia_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + MaxTemp_WarmestWeek + Precip_DriestWk + Precip_WettestWk + Precip_ColdestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_DriestQ + Moisture_Seasonality + MeanMoisture_WarmestQ + Elev + Human_Impact,
