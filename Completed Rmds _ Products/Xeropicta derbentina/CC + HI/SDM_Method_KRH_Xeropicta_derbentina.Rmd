...
```{r}
sdmdata<-read.csv(file='Prietocella_barbara_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~   Mean_Diurnal_Temp_Range + Isothermality + MeanTemp_DriestQ + Precip_Seasonality + Precip_WarmestQ + Precip_ColdestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_WarmestQ + Elev + Human_Impact,
