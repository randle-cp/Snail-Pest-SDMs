...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Xerolenta_obvia_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Isothermality + Temp_Seasonality + MinTemp_ColdestWeek + Precip_Seasonality + Highest_Weekly_Rad + Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_DriestQ + Moisture_Seasonality + MeanMoisture_ColdestQ + Elev + Human_Impact,
