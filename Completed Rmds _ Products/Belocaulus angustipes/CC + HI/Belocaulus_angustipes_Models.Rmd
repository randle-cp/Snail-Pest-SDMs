...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Belocaulus_angustipes_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Ann_Mean_Temp + Mean_Diurnal_Temp_Range + MeanTemp_WettestQ +    
Precip_DriestWk + Precip_WettestWk + Ann_Mean_Rad + Rad_WettestQ + Rad_DriestQ + Rad_ColdestQ + Moisture_Seasonality + Elev + Human_Impact                      ,
