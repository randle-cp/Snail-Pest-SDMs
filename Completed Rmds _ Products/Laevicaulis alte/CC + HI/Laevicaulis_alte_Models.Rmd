...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Laevicaulis_alte_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Mean_Diurnal_Temp_Range + Temp_Seasonality + MaxTemp_WarmestWeek +    
MeanTemp_WettestQ + Precip_WettestWk + Precip_WarmestQ + Precip_ColdestQ + Lowest_Weekly_Seasonality + Rad_WettestQ + Rad_DriestQ + Rad_WarmestQ + Highest_Weekly_Moisture + Elev + Human_Impact                      ,
