...
```{r}
sdmdata<-read.csv(file='C:/Users/kscih/OneDrive/Documents/School/Thesis/Snail_Data/Arion_subfuscus_qGIS_clean.csv')
...
```{r}
colnames(train_data)
gam <- gam(pa ~ Ann_Mean_Temp + Mean_Diurnal_Temp_Range + Isothermality + MeanTemp_WettestQ + Precip_Seasonality + Precip_WarmestQ + Highest_Weekly_Rad + Lowest_Weekly_Seasonality + Rad_DriestQ + Moisture_Seasonality + Elev + Human_Impact,
